  ...
  <div>
    ...
    <main class="news-page">
      ...
      <div class="news-list">
        ...
        <p v-if="newsListItems.length === 0" class="no-news-message">
...
import allNewsData from '../Datas/newsData.js' // Import the news data

// Convert the news data object into an array for v-for
const newsListItems = computed(() => {
  return Object.values(allNewsData)
